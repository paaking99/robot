...
#include "test_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const test_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::msg::Sphere & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const test_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
get_message_type_support_handle<test_interfaces::msg::Sphere>()
{
  return &test_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, msg, Sphere)() {
  return &test_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
