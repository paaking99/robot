...
#include "test_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const test_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &test_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, msg, Num)() {
  return &test_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
