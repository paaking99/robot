...
#include <stddef.h>
#include "test_interfaces/msg/detail/num__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  test_interfaces__msg__Num__init(message_memory);
}

void Num__rosidl_typesupport_introspection_c__Num_fini_function(void * message_memory)
{
  test_interfaces__msg__Num__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers Num__rosidl_typesupport_introspection_c__Num_message_members = {
  ...
  "Num",  // message name
  1,  // number of fields
  sizeof(test_interfaces__msg__Num),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, msg, Num)() {
