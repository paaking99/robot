...
{
  new (message_memory) test_interfaces::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_interfaces::msg::Sphere *>(message_memory);
...
{
  return &::test_interfaces::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces, msg, Sphere)() {
  return &::test_interfaces::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
