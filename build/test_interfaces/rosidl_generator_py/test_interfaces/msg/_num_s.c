...
bool test_interfaces__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * test_interfaces__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_interfaces.msg._num");
