...
#include "test_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_c.h"
...
size_t get_serialized_size_test_interfaces__msg__Sphere(
  const void * untyped_ros_message,
...
static uint32_t _Sphere__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_interfaces__msg__Sphere(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_interfaces
size_t max_serialized_size_test_interfaces__msg__Sphere(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_test_interfaces__msg__Sphere(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, msg, Sphere)() {
